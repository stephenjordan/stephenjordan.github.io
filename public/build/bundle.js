...
var app = (function () {
    ...
    const file$n = "src\\components\\header\\Header.svelte";
    ...
    const file$m = "src\\components\\search\\Search_result.svelte";
    ...
    class Search_result extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$m, create_fragment$m, safe_not_equal, { result_data: 0, matching_text: 1 });
    ...
    const file$l = "src\\components\\search\\Search_bar.svelte";
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$l, 28, 12, 1052);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$l(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "placeholder", "Search all algorithms...");
    			attr_dev(input, "class", "svelte-1jblrb6");
    			add_location(input, file$l, 26, 8, 835);
    			attr_dev(div0, "class", "dropdown svelte-1jblrb6");
    			add_location(div0, file$l, 25, 4, 803);
    			attr_dev(div1, "id", "search-bar");
    			attr_dev(div1, "class", "svelte-1jblrb6");
    			add_location(div1, file$l, 24, 0, 776);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$k = "src\\components\\display_info\\references\\Reference.svelte";
    ...
    function create_each_block$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$k, 23, 23, 464);
    			attr_dev(p, "class", "svelte-y6159r");
    			add_location(p, file$k, 23, 20, 461);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$k(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$k, 9, 16, 115);
    			add_location(td0, file$k, 8, 12, 93);
    			add_location(td1, file$k, 11, 12, 168);
    			add_location(tr0, file$k, 7, 8, 75);
    			add_location(td2, file$k, 16, 12, 236);
    			attr_dev(p1, "class", "svelte-y6159r");
    			add_location(p1, file$k, 20, 16, 297);
    			attr_dev(p2, "class", "svelte-y6159r");
    			add_location(p2, file$k, 21, 16, 342);
    			attr_dev(p3, "class", "svelte-y6159r");
    			add_location(p3, file$k, 25, 16, 556);
    			add_location(td3, file$k, 19, 12, 275);
    			add_location(tr1, file$k, 15, 8, 218);
    			add_location(table, file$k, 6, 4, 58);
    			attr_dev(div, "class", "svelte-y6159r");
    			add_location(div, file$k, 5, 0, 47);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$j = "src\\components\\display_info\\algorithm\\Algorithm.svelte";
    ...
    function create_if_block_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$j, 49, 8, 1534);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(b, file$j, 53, 15, 1710);
    			add_location(p, file$j, 53, 12, 1707);
    			attr_dev(div0, "id", "list-references");
    			attr_dev(div0, "class", "svelte-11ddwr5");
    			add_location(div0, file$j, 54, 12, 1746);
    			attr_dev(div1, "id", "references");
    			add_location(div1, file$j, 52, 8, 1655);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, p);
    ...
    function create_fragment$j(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(b0, file$j, 43, 7, 1242);
    			html_tag.a = null;
    			add_location(p0, file$j, 43, 4, 1239);
    			add_location(b1, file$j, 44, 7, 1299);
    			html_tag_1.a = null;
    			add_location(p1, file$j, 44, 4, 1296);
    			add_location(b2, file$j, 45, 7, 1346);
    			html_tag_2.a = null;
    			add_location(p2, file$j, 45, 4, 1343);
    			add_location(b3, file$j, 46, 7, 1401);
    			html_tag_3.a = null;
    			add_location(p3, file$j, 46, 4, 1398);
    			add_location(b4, file$j, 47, 7, 1454);
    			html_tag_4.a = null;
    			add_location(p4, file$j, 47, 4, 1451);
    			attr_dev(div, "id", "algorithm-wrapper");
    			attr_dev(div, "class", "svelte-11ddwr5");
    			add_location(div, file$j, 42, 0, 1188);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Algorithm extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$j, create_fragment$j, safe_not_equal, { alg_data: 0, alone: 1 });
    ...
    const file$i = "src\\components\\display_info\\acknowledgments\\Acknowledgments.svelte";
    ...
    function create_fragment$i(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a19, file$i, 35, 12, 2272);
    			add_location(li23, file$i, 35, 8, 2268);
    			attr_dev(a20, "target", "_blank");
    			attr_dev(a20, "href", "http://quics.umd.edu/people/yuan-su");
    			attr_dev(a20, "class", "svelte-17xl9z8");
    			add_location(a20, file$i, 36, 12, 2385);
    			add_location(li24, file$i, 36, 8, 2381);
    			add_location(li25, file$i, 37, 8, 2473);
    			add_location(li26, file$i, 38, 8, 2503);
    			attr_dev(a21, "target", "_blank");
    			attr_dev(a21, "href", "http://web.maths.unsw.edu.au/~igorshparlinski/");
    			attr_dev(a21, "class", "svelte-17xl9z8");
    			add_location(a21, file$i, 39, 12, 2538);
    			add_location(li27, file$i, 39, 8, 2534);
    			add_location(li28, file$i, 40, 8, 2646);
    			...
    			add_location(a26, file$i, 45, 12, 3120);
    			add_location(li33, file$i, 45, 8, 3116);
    			attr_dev(a27, "target", "_blank");
    			attr_dev(a27, "href", "https://en.wikipedia.org/wiki/Jack_Hidary");
    			attr_dev(a27, "class", "svelte-17xl9z8");
    			add_location(a27, file$i, 46, 12, 3244);
    			add_location(li34, file$i, 46, 8, 3240);
    			...
    			add_location(a28, file$i, 47, 12, 3346);
    			add_location(li35, file$i, 47, 8, 3342);
    			attr_dev(a29, "target", "_blank");
    			attr_dev(a29, "href", "https://github.com/nvitucci");
    			attr_dev(a29, "class", "svelte-17xl9z8");
    			add_location(a29, file$i, 48, 12, 3481);
    			add_location(li36, file$i, 48, 8, 3477);
    			attr_dev(a30, "target", "_blank");
    			attr_dev(a30, "href", "https://kunalmarwaha.com");
    			attr_dev(a30, "class", "svelte-17xl9z8");
    			add_location(a30, file$i, 49, 12, 3572);
    			add_location(li37, file$i, 49, 8, 3568);
    			...
    			add_location(a31, file$i, 50, 12, 3659);
    			add_location(li38, file$i, 50, 8, 3655);
    ...
    const file$h = "src\\components\\display_info\\references\\References.svelte";
    ...
    function create_fragment$h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$h, 11, 4, 310);
    			add_location(div, file$h, 10, 0, 282);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\components\display_info\all_algs\All_cat_algs.svelte generated by Svelte v3.41.0 */

    const { Object: Object_1$3 } = globals;
    const file$g = "src\\components\\display_info\\all_algs\\All_cat_algs.svelte";
    ...
    // (16:4) {#each Object.entries(category_data.algs) as [alg_id, alg]}
    function create_each_block$3(ctx) {
    	...
    	algorithm = new Algorithm({
    			props: { alg_data: /*alg*/ ctx[2], alone: false },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			hr = element("hr");
    			add_location(hr, file$g, 17, 8, 451);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*category_data*/ 1) algorithm_changes.alg_data = /*alg*/ ctx[2];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(16:4) {#each Object.entries(category_data.algs) as [alg_id, alg]}",
    		ctx
    	});
    ...
    function create_fragment$g(ctx) {
    	let div;
    	let h3;
    	let t0_value = /*category_data*/ ctx[0].name + "";
    	let t0;
    	let t1;
    	let div_transition;
    	let current;
    	let each_value = Object.entries(/*category_data*/ ctx[0].algs);
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$g, 14, 4, 296);
    			add_location(div, file$g, 13, 0, 268);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if ((!current || dirty & /*category_data*/ 1) && t0_value !== (t0_value = /*category_data*/ ctx[0].name + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*Object, category_data*/ 1) {
    				each_value = Object.entries(/*category_data*/ ctx[0].algs);
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$g($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('All_cat_algs', slots, []);

    	afterUpdate(() => {
    		MathJax.typeset();
    	});

    	let { category_data } = $$props;
    	const writable_props = ['category_data'];

    	Object_1$3.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<All_cat_algs> was created with unknown prop '${key}'`);
    	});

    	$$self.$$set = $$props => {
    		if ('category_data' in $$props) $$invalidate(0, category_data = $$props.category_data);
    	};
    ...
    class All_cat_algs extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$g, create_fragment$g, safe_not_equal, { category_data: 0 });

    		dispatch_dev("SvelteRegisterComponent", {
    			component: this,
    			tagName: "All_cat_algs",
    			options,
    			id: create_fragment$g.name
    		});
    		...
    		if (/*category_data*/ ctx[0] === undefined && !('category_data' in props)) {
    			console.warn("<All_cat_algs> was created without expected prop 'category_data'");
    		}
    	}

    	get category_data() {
    		throw new Error("<All_cat_algs>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set category_data(value) {
    		throw new Error("<All_cat_algs>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    const file$f = "src\\components\\display_info\\all_algs\\All_algs.svelte";
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			create_component(all_cat_algs.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(all_cat_algs, target, anchor);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(all_cat_algs.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(all_cat_algs.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(all_cat_algs, detaching);
    		}
    	};
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$f, 13, 4, 320);
    			add_location(div, file$f, 12, 0, 292);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$e = "src\\components\\display_info\\translations\\Translations.svelte";
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			br1 = element("br");
    			br2 = element("br");
    			add_location(h2, file$e, 5, 4, 97);
    			add_location(p, file$e, 6, 4, 124);
    			attr_dev(a0, "href", "https://www.qmedia.jp/algorithm-zoo/");
    			attr_dev(a0, "class", "svelte-17xl9z8");
    			add_location(a0, file$e, 8, 8, 203);
    			add_location(br0, file$e, 8, 67, 262);
    			attr_dev(a1, "href", "https://www.qtumist.com/quantum-algorithm-zoo");
    			attr_dev(a1, "class", "svelte-17xl9z8");
    			add_location(a1, file$e, 9, 8, 276);
    			add_location(br1, file$e, 9, 75, 343);
    			add_location(br2, file$e, 9, 79, 347);
    			attr_dev(div0, "class", "navlist");
    			add_location(div0, file$e, 7, 4, 172);
    			add_location(div1, file$e, 4, 0, 69);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$d = "src\\components\\display_info\\other_surveys\\Other_surveys.svelte";
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$d, 6, 4, 125);
    			attr_dev(a0, "href", "http://www.amazon.com/Quantum-Computation-Information-Cambridge-Sciences/dp/0521635039");
    			attr_dev(a0, "class", "svelte-17xl9z8");
    			add_location(a0, file$d, 8, 8, 217);
    			add_location(br0, file$d, 9, 27, 350);
    			attr_dev(a1, "href", "http://www.cs.umd.edu/~amchilds/qa/");
    			attr_dev(a1, "class", "svelte-17xl9z8");
    			add_location(a1, file$d, 10, 8, 364);
    			add_location(br1, file$d, 10, 64, 420);
    			attr_dev(a2, "href", "http://theory.caltech.edu/~preskill/ph229/");
    			attr_dev(a2, "class", "svelte-17xl9z8");
    			add_location(a2, file$d, 11, 8, 434);
    			add_location(br2, file$d, 11, 73, 499);
    			attr_dev(a3, "href", "http://arxiv.org/abs/0808.0369");
    			attr_dev(a3, "class", "svelte-17xl9z8");
    			add_location(a3, file$d, 12, 8, 513);
    			add_location(br3, file$d, 12, 58, 563);
    			attr_dev(a4, "href", "http://arxiv.org/abs/0812.0380");
    			attr_dev(a4, "class", "svelte-17xl9z8");
    			add_location(a4, file$d, 13, 8, 577);
    			add_location(br4, file$d, 13, 71, 640);
    			attr_dev(a5, "href", "http://arxiv.org/abs/1206.6126");
    			attr_dev(a5, "class", "svelte-17xl9z8");
    			add_location(a5, file$d, 14, 8, 654);
    			add_location(br5, file$d, 14, 71, 717);
    			attr_dev(a6, "href", "http://cacm.acm.org/magazines/2010/2/69352-recent-progress-in-quantum-algorithms/fulltext");
    			attr_dev(a6, "class", "svelte-17xl9z8");
    			add_location(a6, file$d, 15, 8, 731);
    			add_location(br6, file$d, 15, 129, 852);
    			attr_dev(a7, "href", "http://arxiv.org/abs/1511.04206");
    			attr_dev(a7, "class", "svelte-17xl9z8");
    			add_location(a7, file$d, 16, 8, 866);
    			add_location(br7, file$d, 16, 63, 921);
    			attr_dev(a8, "href", "https://www.amazon.com/Quantum-Computing-Approach-Jack-Hidary/dp/3030239217/");
    			attr_dev(a8, "class", "svelte-17xl9z8");
    			add_location(a8, file$d, 17, 8, 935);
    			add_location(br8, file$d, 17, 105, 1032);
    			add_location(br9, file$d, 17, 109, 1036);
    			attr_dev(div0, "class", "navlist");
    			add_location(div0, file$d, 7, 4, 186);
    ...
    const file$c = "src\\components\\display_info\\terminology\\Terminology.svelte";
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span4, file$c, 6, 552, 671);
    			...
    			add_location(span5, file$c, 6, 449, 568);
    			...
    			add_location(span6, file$c, 6, 890, 1009);
    			...
    			add_location(span7, file$c, 6, 360, 479);
    			attr_dev(nobr0, "aria-hidden", "true");
    			add_location(nobr0, file$c, 6, 335, 454);
    			add_location(mi0, file$c, 6, 1149, 1268);
    			attr_dev(math0, "xmlns", "http://www.w3.org/1998/Math/MathML");
    			add_location(math0, file$c, 6, 1100, 1219);
    			attr_dev(span8, "class", "MJX_Assistive_MathML");
    			attr_dev(span8, "role", "presentation");
    			add_location(span8, file$c, 6, 1045, 1164);
    			...
    			add_location(span18, file$c, 7, 612, 1979);
    			...
    			add_location(span19, file$c, 7, 509, 1876);
    			...
    			add_location(span20, file$c, 7, 1298, 2665);
    			...
    			add_location(span21, file$c, 7, 420, 1787);
    			attr_dev(nobr1, "aria-hidden", "true");
    			add_location(nobr1, file$c, 7, 395, 1762);
    			add_location(mi1, file$c, 7, 1557, 2924);
    			attr_dev(mo0, "stretchy", "false");
    			add_location(mo0, file$c, 7, 1567, 2934);
    			add_location(mi2, file$c, 7, 1594, 2961);
    			attr_dev(mo1, "stretchy", "false");
    			add_location(mo1, file$c, 7, 1604, 2971);
    			attr_dev(math1, "xmlns", "http://www.w3.org/1998/Math/MathML");
    			add_location(math1, file$c, 7, 1508, 2875);
    			attr_dev(span22, "class", "MJX_Assistive_MathML");
    			attr_dev(span22, "role", "presentation");
    			add_location(span22, file$c, 7, 1453, 2820);
    			...
    			add_location(span31, file$c, 8, 590, 3729);
    			...
    			add_location(span32, file$c, 8, 487, 3626);
    			...
    			add_location(span33, file$c, 8, 1185, 4324);
    			...
    			add_location(span34, file$c, 8, 398, 3537);
    			attr_dev(nobr2, "aria-hidden", "true");
    			add_location(nobr2, file$c, 8, 373, 3512);
    			add_location(mi3, file$c, 8, 1444, 4583);
    			attr_dev(mo2, "stretchy", "false");
    			add_location(mo2, file$c, 8, 1454, 4593);
    			add_location(mi4, file$c, 8, 1481, 4620);
    			attr_dev(mo3, "stretchy", "false");
    			add_location(mo3, file$c, 8, 1491, 4630);
    			attr_dev(math2, "xmlns", "http://www.w3.org/1998/Math/MathML");
    			add_location(math2, file$c, 8, 1395, 4534);
    			attr_dev(span35, "class", "MJX_Assistive_MathML");
    			attr_dev(span35, "role", "presentation");
    			add_location(span35, file$c, 8, 1340, 4479);
    			...
    			add_location(span43, file$c, 8, 2989, 6128);
    			...
    			add_location(span44, file$c, 8, 3415, 6554);
    			...
    			add_location(span45, file$c, 8, 3516, 6655);
    			...
    			add_location(span48, file$c, 8, 3748, 6887);
    			...
    			add_location(span52, file$c, 8, 3662, 6801);
    			attr_dev(span53, "class", "msubsup");
    			attr_dev(span53, "id", "MathJax-Span-3998");
    			add_location(span53, file$c, 8, 3617, 6756);
    			...
    			add_location(span63, file$c, 8, 2385, 5524);
    			...
    			add_location(span64, file$c, 8, 2282, 5421);
    			...
    			add_location(span65, file$c, 8, 4616, 7755);
    			...
    			add_location(span66, file$c, 8, 2193, 5332);
    			attr_dev(nobr3, "aria-hidden", "true");
    			add_location(nobr3, file$c, 8, 2168, 5307);
    			add_location(mi5, file$c, 8, 4875, 8014);
    			add_location(mo4, file$c, 8, 4885, 8024);
    			add_location(mn, file$c, 8, 4901, 8040);
    			attr_dev(mi6, "mathvariant", "normal");
    			add_location(mi6, file$c, 8, 4941, 8080);
    			attr_dev(mo5, "stretchy", "false");
    			add_location(mo5, file$c, 8, 4972, 8111);
    			add_location(mi7, file$c, 8, 5005, 8144);
    			add_location(mi8, file$c, 8, 5015, 8154);
    			add_location(msup0, file$c, 8, 4999, 8138);
    			attr_dev(mo6, "stretchy", "false");
    			add_location(mo6, file$c, 8, 5032, 8171);
    			attr_dev(mrow0, "class", "MJX-TeXAtom-ORD");
    			add_location(mrow0, file$c, 8, 4911, 8050);
    			add_location(msup1, file$c, 8, 4895, 8034);
    			attr_dev(math3, "xmlns", "http://www.w3.org/1998/Math/MathML");
    			add_location(math3, file$c, 8, 4826, 7965);
    			attr_dev(span67, "class", "MJX_Assistive_MathML");
    			attr_dev(span67, "role", "presentation");
    			add_location(span67, file$c, 8, 4771, 7910);
    			...
    			add_location(span82, file$c, 10, 2033, 10434);
    			...
    			add_location(span88, file$c, 10, 2447, 10848);
    			...
    			add_location(span89, file$c, 10, 2553, 10954);
    			...
    			add_location(span93, file$c, 10, 793, 9194);
    			...
    			add_location(span94, file$c, 10, 690, 9091);
    			...
    			add_location(span95, file$c, 10, 2859, 11260);
    			...
    			add_location(span96, file$c, 10, 601, 9002);
    			attr_dev(nobr4, "aria-hidden", "true");
    			add_location(nobr4, file$c, 10, 576, 8977);
    			add_location(mi9, file$c, 10, 3118, 11519);
    			add_location(mo7, file$c, 10, 3128, 11529);
    			attr_dev(mi10, "mathvariant", "normal");
    			add_location(mi10, file$c, 10, 3138, 11539);
    			add_location(mo8, file$c, 10, 3169, 11570);
    			attr_dev(mi11, "mathvariant", "normal");
    			add_location(mi11, file$c, 10, 3179, 11580);
    			add_location(mo9, file$c, 10, 3210, 11611);
    			add_location(mi12, file$c, 10, 3257, 11658);
    			add_location(mo10, file$c, 10, 3267, 11668);
    			add_location(mover, file$c, 10, 3250, 11651);
    			attr_dev(mrow1, "class", "MJX-TeXAtom-ORD");
    			add_location(mrow1, file$c, 10, 3220, 11621);
    			add_location(mo11, file$c, 10, 3292, 11693);
    			add_location(mo12, file$c, 10, 3302, 11703);
    			add_location(mo13, file$c, 10, 3312, 11713);
    			add_location(mo14, file$c, 10, 3322, 11723);
    			attr_dev(math4, "xmlns", "http://www.w3.org/1998/Math/MathML");
    			add_location(math4, file$c, 10, 3069, 11470);
    			attr_dev(span97, "class", "MJX_Assistive_MathML");
    			attr_dev(span97, "role", "presentation");
    			add_location(span97, file$c, 10, 3014, 11415);
    			...
    			add_location(span98, file$c, 10, 104, 8505);
    			attr_dev(script4, "type", "math/tex");
    			attr_dev(script4, "id", "MathJax-Element-349");
    			add_location(script4, file$c, 10, 3353, 11754);
    			attr_dev(a, "href", "http://en.wikipedia.org/wiki/Big_O_notation");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$c, 11, 8, 11879);
    			add_location(p, file$c, 6, 4, 123);
    ...
    const file$b = "src\\components\\display_info\\about\\About.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$b, 6, 4, 117);
    			...
    			add_location(img, file$b, 8, 8, 217);
    			attr_dev(a0, "href", "https://www.microsoft.com/en-us/research/people/stjorda/");
    			add_location(a0, file$b, 7, 7, 140);
    			add_location(p1, file$b, 7, 4, 137);
    			attr_dev(a1, "href", "https://www.microsoft.com/en-us/research/people/stjorda/");
    			add_location(a1, file$b, 10, 7, 356);
    			add_location(p2, file$b, 10, 4, 353);
    			attr_dev(a2, "href", "https://www.microsoft.com/en-us/research/group/microsoft-quantum-redmond-quarc/");
    			add_location(a2, file$b, 11, 7, 454);
    			add_location(p3, file$b, 11, 4, 451);
    			add_location(br0, file$b, 12, 4, 575);
    			add_location(p4, file$b, 13, 4, 585);
    			add_location(p5, file$b, 14, 4, 630);
    			add_location(br1, file$b, 15, 4, 673);
    			attr_dev(a3, "href", "https://github.com/stephenjordan/stephenjordan.github.io");
    			attr_dev(a3, "target", "_blank");
    			add_location(a3, file$b, 18, 37, 900);
    			add_location(p6, file$b, 16, 4, 683);
    ...
    const file$a = "src\\components\\display_info\\algorithm\\Display_algorithm.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			key_block.c();
    			add_location(h2, file$a, 15, 4, 340);
    			add_location(div, file$a, 14, 0, 329);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$9 = "src\\components\\display_info\\Display_info.svelte";
    ...
    function create_if_block_1$1(ctx) {
    	...
    	all_cat_algs = new All_cat_algs({
    			props: {
    				category_data: /*$cat_to_display*/ ctx[1]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const all_cat_algs_changes = {};
    			if (dirty & /*$cat_to_display*/ 2) all_cat_algs_changes.category_data = /*$cat_to_display*/ ctx[1];
    			all_cat_algs.$set(all_cat_algs_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(all_cat_algs.$$.fragment, local);
    ...
    function create_if_block$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(17:4) {#if $to_display === \\\"all_algs\\\"}",
    		ctx
    	});
    ...
    function create_fragment$9(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		...
    		if (/*$to_display*/ ctx[0] === "category") return 1;
    		if (/*$to_display*/ ctx[0] === "algorithm") return 2;
    		if (/*$to_display*/ ctx[0] === "acknowledgments") return 3;
    		if (/*$to_display*/ ctx[0] === "references") return 4;
    		if (/*$to_display*/ ctx[0] === "translations") return 5;
    		if (/*$to_display*/ ctx[0] === "other_surveys") return 6;
    		if (/*$to_display*/ ctx[0] === "terminology") return 7;
    		if (/*$to_display*/ ctx[0] === "about") return 8;
    		return -1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 15, 0, 744);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	validate_store(cat_to_display, 'cat_to_display');
    	component_subscribe($$self, cat_to_display, $$value => $$invalidate(1, $cat_to_display = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	return [$to_display, $cat_to_display];
    }
    ...
    const file$8 = "src\\components\\menu\\categories_menu\\Categories_menu_tab.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 16, 0, 380);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$7 = "src\\components\\menu\\categories_menu\\Categories_menu.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$7, 8, 4, 213);
    			add_location(div1, file$7, 7, 0, 202);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$6 = "src\\components\\menu\\Menu_tab.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$6, 25, 4, 753);
    			add_location(div1, file$6, 24, 0, 742);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$5 = "src\\components\\menu\\categories_menu\\algorithms_menu\\Algorithms_menu_tab.svelte";
    ...
    /* src\components\menu\categories_menu\algorithms_menu\Algorithms_menu_cat_tab.svelte generated by Svelte v3.41.0 */
    const file$4 = "src\\components\\menu\\categories_menu\\algorithms_menu\\Algorithms_menu_cat_tab.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			div.textContent = "All in category";
    			attr_dev(div, "class", "alg_menu_tab w3-round-xlarge svelte-jts6o0");
    			add_location(div, file$4, 12, 0, 248);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", /*act*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	let $to_display;
    	validate_store(cat_to_display, 'cat_to_display');
    	component_subscribe($$self, cat_to_display, $$value => $$invalidate(2, $cat_to_display = $$value));
    	validate_store(to_display, 'to_display');
    	component_subscribe($$self, to_display, $$value => $$invalidate(3, $to_display = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Algorithms_menu_cat_tab', slots, []);
    	let { category_data } = $$props;

    	function act() {
    		set_store_value(to_display, $to_display = "category", $to_display);
    		set_store_value(cat_to_display, $cat_to_display = category_data, $cat_to_display);
    	}

    	const writable_props = ['category_data'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Algorithms_menu_cat_tab> was created with unknown prop '${key}'`);
    	});

    	$$self.$$set = $$props => {
    		if ('category_data' in $$props) $$invalidate(1, category_data = $$props.category_data);
    	};
    	...
    	return [act, category_data];
    }

    class Algorithms_menu_cat_tab extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { category_data: 1 });

    		dispatch_dev("SvelteRegisterComponent", {
    			component: this,
    			tagName: "Algorithms_menu_cat_tab",
    			options,
    			id: create_fragment$4.name
    		});
    		...
    		if (/*category_data*/ ctx[1] === undefined && !('category_data' in props)) {
    			console.warn("<Algorithms_menu_cat_tab> was created without expected prop 'category_data'");
    		}
    	}

    	get category_data() {
    		throw new Error("<Algorithms_menu_cat_tab>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set category_data(value) {
    		throw new Error("<Algorithms_menu_cat_tab>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    // (11:4) {#each Object.entries(algorithms.default[$algs_of_cat_menu]) as [cat, algs]}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(11:4) {#each Object.entries(algorithms.default[$algs_of_cat_menu]) as [cat, algs]}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	let div;
    	let algorithms_menu_cat_tab;
    	let t;
    	let div_transition;
    	let current;

    	algorithms_menu_cat_tab = new Algorithms_menu_cat_tab({
    			props: {
    				category_data: {
    					"name": /*$algs_of_cat_menu*/ ctx[0],
    					"algs": algorithms.default[/*$algs_of_cat_menu*/ ctx[0]]
    				}
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			create_component(algorithms_menu_cat_tab.$$.fragment);
    			t = space();
    			...
    			add_location(div, file$3, 8, 0, 300);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(algorithms_menu_cat_tab, div, null);
    			append_dev(div, t);
    		...
    		p: function update(ctx, [dirty]) {
    			const algorithms_menu_cat_tab_changes = {};

    			if (dirty & /*$algs_of_cat_menu*/ 1) algorithms_menu_cat_tab_changes.category_data = {
    				"name": /*$algs_of_cat_menu*/ ctx[0],
    				"algs": algorithms.default[/*$algs_of_cat_menu*/ ctx[0]]
    			};

    			algorithms_menu_cat_tab.$set(algorithms_menu_cat_tab_changes);
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(algorithms_menu_cat_tab.$$.fragment, local);
    		...
    		o: function outro(local) {
    			transition_out(algorithms_menu_cat_tab.$$.fragment, local);
    			each_blocks = each_blocks.filter(Boolean);
    		...
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    			destroy_component(algorithms_menu_cat_tab);
    			destroy_each(each_blocks, detaching);
    			if (detaching && div_transition) div_transition.end();
    		}
    	};
